...
## 推荐的策划配置准则（模板设计经验）
- **每个模板 6~8 个槽位**，避免过长难理解
- **每个槽位 2~4 个档位**，避免“无限微调”
- 提供至少 2 种“有意义的顺序分歧点”：例如 Target 与 Condition、Debuff 与 Damage、Timeline 前后
- 将高风险能力放在模板级 guard（ICD/Cap/MaxSpawn）里，玩家不可移除
